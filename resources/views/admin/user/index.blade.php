<x-app-layout>
    ...
    <div class="container mx-auto px-4 md:px-10 lg:px-20 py-6">
                ...
                <section class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div id="dropdownAction"
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li>
                                <a href="#" id="createUserBtn" data-modal-target="userModal"
        ...
        <div id="userModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <!-- Modal toggle -->
                                <a href="" id="detailUserButton" type="button"
                                    data-modal-target="detailUserModal" data-id="{{ $user->id }}"
                                    class="detailUser text-base text-slate-400"><i
                                        class="fa-solid fa-circle-info mx-2"></i></a>
                                <a href="/user/{{ $user->id }}/edit" type="button" data-modal-target="userModal"
                                    data-id="{{ $user->id }}" class="editUser text-base text-blue-400"><i
            ...
            <!-- Detail user modal -->
            <div id="detailUserModal" tabindex="-1" aria-hidden="true"
                    ...
                    <section class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                            ...
                            <button type="button"
                                ...
                                data-modal-hide="detailUserModal">
                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="number" name="id" id="detail_id"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required="" disabled value="1">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="username"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                                    <input disabled type="text" name="detail" id="detail_username"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Bonnie" required="" value="tes">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="phone"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone</label>
                                    <input disabled type="text" name="detail_phone" id="detail_phone"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required="" value="08193288">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="email"
                                    ...
                                    <input type="email" name="email" id="detail_email"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required="" disabled value="tes@gmail.com">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="saldo"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Saldo</label>
                                    <input type="number" name="saldo" id="detail_saldo"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required="" disabled value="100000">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="level"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Level</label>
                                    <input type="text" name="level" id="detail_level"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 capitalize"
                                        disabled value="Admin">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="status"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status</label>
                                    <input type="text" name="status" id="detail_status"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 capitalize"
                        ...
                        <div
                            ...
                            <a href="/user"
                                class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Close</a>
                        </div>
                    </section>
                </div>
            </div>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="username" id="username"
                                        ...
                                        placeholder="Masukkan nama.." required="" value="{{ old('username') }}">
                                    @error('username')
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Nomor diawali 08" required="" value="{{ old('phone') }}">
                                    @error('phone')
                                        <p id="filled_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                            <span class="font-small">{{ $message }} </span>
                                        </p>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="number" name="saldo" id="saldo"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Saldo user.." required="" value="{{ old('saldo', 0) }}">
                                    @error('number')
                                        <p id="filled_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                            <span class="font-small">{{ $message }} </span>
                                        </p>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select id="level" name="level"
                                        ...
                                        <option value="premium" {{ old('level') == 'premium' ? 'selected' : '' }}>
                                            Premium</option>
                                ...
                                <div class="col-span-6 sm:col-span-3" id="password_confirmation_col">
                                    <label for="password_confirmation"
                                        class="password-label block mb-2 text-sm font-medium text-gray-900 dark:text-white">Repeat
                                        Password </label>
